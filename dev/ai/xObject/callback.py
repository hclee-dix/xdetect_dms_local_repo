...
from dev.ai.xBase.label import YOLO_COCO
#
...
class XObjectDetectorCallback(XCallback):
    ...
    def onPredictEnd(self,imageList,perfList,resultList):
        ...
        ##
        result,accuracy,perf = getAvgResultFromTotalFrame(perfList,resultList)
...
class XObjectTrainerCallback(XCallback):
