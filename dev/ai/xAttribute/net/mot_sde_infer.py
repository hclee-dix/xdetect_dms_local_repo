...
from dev.ai.xFalling.net.preprocess import decode_image
...
from dev.ai.xFalling.net.detector import Detector, PredictConfig, load_predictor
from dev.ai.xFalling.net.mot_utils import argsparser, Timer, get_current_memory_mb, video2frames, _is_valid_video
from dev.ai.xFalling.net.mot.tracker import JDETracker, DeepSORTTracker, OCSORTTracker, BOTSORTTracker
from dev.ai.xFalling.net.mot.utils import MOTTimer, write_mot_results, get_crops, clip_box, flow_statistic
from dev.ai.xFalling.net.mot.visualize import plot_tracking, plot_tracking_dict

from dev.ai.xFalling.net.mot.mtmct.utils import parse_bias
from dev.ai.xFalling.net.mot.mtmct.postprocess import trajectory_fusion, sub_cluster, gen_res, print_mtmct_result
from dev.ai.xFalling.net.mot.mtmct.postprocess import get_mtmct_matching_results, save_mtmct_crops, save_mtmct_vis_results
    ...
    def tracking(self, det_results, img=None):
        ...
        if self.use_deepsort_tracker:
            ...
            for t in online_targets:
                ...
                online_ids[0].append(tid)
                online_scores[0].append(tscore)
                online_attr[0].append(np.zeros((26)))
            ...
            r5 = np.array(tracking_outs['online_attr'][0]).reshape(-1,26)
