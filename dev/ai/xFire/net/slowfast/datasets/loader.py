...
from dev.ai.xFire.net.slowfast.datasets.multigrid_helper import ShortCycleBatchSampler
...
def construct_loader(cfg, split, is_precise_bn=False):
    ...
    # logger.info(f"BUILD DATASET: {dataset_name}")
