...
import dev.ai.xFire.net.slowfast.models.losses as losses
import dev.ai.xFire.net.slowfast.utils.distributed as du
import dev.ai.xFire.net.slowfast.utils.logging as logging
from dev.ai.xFire.net.slowfast.models.video_model_builder import X3D, MViT, ResNet, SlowFast
...
def contrastive_parameter_surgery(model, cfg, epoch_exact, cur_iter):
    ...
    if cfg.MODEL.MODEL_NAME == "ContrastiveModel" and cfg.CONTRASTIVE.TYPE == "moco":
        ...
        iters_noupdate = cfg.CONTRASTIVE.QUEUE_LEN // cfg.TRAIN.BATCH_SIZE // cfg.NUM_SHARDS
