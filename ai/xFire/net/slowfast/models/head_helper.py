...
from dev.ai.xFire.net.detectron2_repo.detectron2.layers import ROIAlign
...
from dev.ai.xFire.net.slowfast.models.batchnorm_helper import (
    NaiveSyncBatchNorm1d as NaiveSyncBatchNorm1d,
)
from dev.ai.xFire.net.slowfast.models.nonlocal_helper import Nonlocal
